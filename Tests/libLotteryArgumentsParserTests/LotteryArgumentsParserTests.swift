...
final class LotteryArgumentsParserTests: XCTestCase {
    ...
    static var allTests = [
        ("testThrowingMinimumNumberIsMissingError", testThrowingMinimumNumberIsMissingError),
        ("testThrowingMaximumNumberIsMissingError", testThrowingMaximumNumberIsMissingError),
        ("testThrowingCountIsMissingError", testThrowingCountIsMissingError),
        ("testThrowingCountIsMissingErrorWhenOnlyValueIsMissing", testThrowingCountIsMissingErrorWhenOnlyValueIsMissing),
        ("testNormalParsing", testNormalParsing),
        ("testParsingInDifferentOrder", testParsingInDifferentOrder)
    ]
}
